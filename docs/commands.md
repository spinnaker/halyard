 ...
 * `--managed-pipeline-templates-v2-ui`: Enable managed pipeline templates v2 UI support. Read more at https://blog.spinnaker.io/spinnaker-managed-pipeline-templates-v2-taking-shape-c7503d0a608d
