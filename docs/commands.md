 ...
 * [**hal config deploy ha fiat**](#hal-config-deploy-ha-fiat)
 * [**hal config deploy ha fiat disable**](#hal-config-deploy-ha-fiat-disable)
 * [**hal config deploy ha fiat enable**](#hal-config-deploy-ha-fiat-enable)
 * [**hal config deploy ha front50**](#hal-config-deploy-ha-front50)
 * [**hal config deploy ha front50 disable**](#hal-config-deploy-ha-front50-disable)
 * [**hal config deploy ha front50 enable**](#hal-config-deploy-ha-front50-enable)
 * [**hal config deploy ha gate**](#hal-config-deploy-ha-gate)
 * [**hal config deploy ha gate disable**](#hal-config-deploy-ha-gate-disable)
 * [**hal config deploy ha gate enable**](#hal-config-deploy-ha-gate-enable)
 * [**hal config deploy ha igor**](#hal-config-deploy-ha-igor)
 * [**hal config deploy ha igor disable**](#hal-config-deploy-ha-igor-disable)
 * [**hal config deploy ha igor enable**](#hal-config-deploy-ha-igor-enable)
 * [**hal config deploy ha kayenta**](#hal-config-deploy-ha-kayenta)
 * [**hal config deploy ha kayenta disable**](#hal-config-deploy-ha-kayenta-disable)
 * [**hal config deploy ha kayenta enable**](#hal-config-deploy-ha-kayenta-enable)
 * [**hal config deploy ha orca**](#hal-config-deploy-ha-orca)
 * [**hal config deploy ha orca disable**](#hal-config-deploy-ha-orca-disable)
 * [**hal config deploy ha orca enable**](#hal-config-deploy-ha-orca-enable)
 * [**hal config deploy ha rosco**](#hal-config-deploy-ha-rosco)
 * [**hal config deploy ha rosco disable**](#hal-config-deploy-ha-rosco-disable)
 * [**hal config deploy ha rosco enable**](#hal-config-deploy-ha-rosco-enable)
 ...
 * `fiat`: Manage and view Spinnaker configuration for the fiat high availability service
 * `front50`: Manage and view Spinnaker configuration for the front50 high availability service
 * `gate`: Manage and view Spinnaker configuration for the gate high availability service
 * `igor`: Manage and view Spinnaker configuration for the igor high availability service
 * `kayenta`: Manage and view Spinnaker configuration for the kayenta high availability service
 * `orca`: Manage and view Spinnaker configuration for the orca high availability service
 * `rosco`: Manage and view Spinnaker configuration for the rosco high availability service
...
---
## hal config deploy ha fiat

Manage and view Spinnaker configuration for the fiat high availability service

#### Usage
```
hal config deploy ha fiat [parameters] [subcommands]
```
...
#### Subcommands
 * `disable`: Set the fiat high availability service as disabled
 * `enable`: Set the fiat high availability service as enabled

---
## hal config deploy ha fiat disable

Set the fiat high availability service as disabled

#### Usage
```
hal config deploy ha fiat disable [parameters]
```
...
---
## hal config deploy ha fiat enable

Set the fiat high availability service as enabled

#### Usage
```
hal config deploy ha fiat enable [parameters]
```
...
---
## hal config deploy ha front50

Manage and view Spinnaker configuration for the front50 high availability service

#### Usage
```
hal config deploy ha front50 [parameters] [subcommands]
```
...
#### Subcommands
 * `disable`: Set the front50 high availability service as disabled
 * `enable`: Set the front50 high availability service as enabled

---
## hal config deploy ha front50 disable

Set the front50 high availability service as disabled

#### Usage
```
hal config deploy ha front50 disable [parameters]
```
...
---
## hal config deploy ha front50 enable

Set the front50 high availability service as enabled

#### Usage
```
hal config deploy ha front50 enable [parameters]
```
...
---
## hal config deploy ha gate

Manage and view Spinnaker configuration for the gate high availability service

#### Usage
```
hal config deploy ha gate [parameters] [subcommands]
```
...
#### Subcommands
 * `disable`: Set the gate high availability service as disabled
 * `enable`: Set the gate high availability service as enabled

---
## hal config deploy ha gate disable

Set the gate high availability service as disabled

#### Usage
```
hal config deploy ha gate disable [parameters]
```
...
---
## hal config deploy ha gate enable

Set the gate high availability service as enabled

#### Usage
```
hal config deploy ha gate enable [parameters]
```
...
---
## hal config deploy ha igor

Manage and view Spinnaker configuration for the igor high availability service

#### Usage
```
hal config deploy ha igor [parameters] [subcommands]
```
...
#### Subcommands
 * `disable`: Set the igor high availability service as disabled
 * `enable`: Set the igor high availability service as enabled

---
## hal config deploy ha igor disable

Set the igor high availability service as disabled

#### Usage
```
hal config deploy ha igor disable [parameters]
```
...
---
## hal config deploy ha igor enable

Set the igor high availability service as enabled

#### Usage
```
hal config deploy ha igor enable [parameters]
```
...
---
## hal config deploy ha kayenta

Manage and view Spinnaker configuration for the kayenta high availability service

#### Usage
```
hal config deploy ha kayenta [parameters] [subcommands]
```
...
#### Subcommands
 * `disable`: Set the kayenta high availability service as disabled
 * `enable`: Set the kayenta high availability service as enabled

---
## hal config deploy ha kayenta disable

Set the kayenta high availability service as disabled

#### Usage
```
hal config deploy ha kayenta disable [parameters]
```
...
---
## hal config deploy ha kayenta enable

Set the kayenta high availability service as enabled

#### Usage
```
hal config deploy ha kayenta enable [parameters]
```
...
---
## hal config deploy ha orca

Manage and view Spinnaker configuration for the orca high availability service

#### Usage
```
hal config deploy ha orca [parameters] [subcommands]
```
...
#### Subcommands
 * `disable`: Set the orca high availability service as disabled
 * `enable`: Set the orca high availability service as enabled

---
## hal config deploy ha orca disable

Set the orca high availability service as disabled

#### Usage
```
hal config deploy ha orca disable [parameters]
```
...
Set the orca high availability service as enabled

#### Usage
```
hal config deploy ha orca enable [parameters]
```
...
---
## hal config deploy ha rosco

Manage and view Spinnaker configuration for the rosco high availability service

#### Usage
```
hal config deploy ha rosco [parameters] [subcommands]
```
...
#### Subcommands
 * `disable`: Set the rosco high availability service as disabled
 * `enable`: Set the rosco high availability service as enabled

---
## hal config deploy ha rosco disable

Set the rosco high availability service as disabled

#### Usage
```
hal config deploy ha rosco disable [parameters]
```
...
---
## hal config deploy ha rosco enable

Set the rosco high availability service as enabled

#### Usage
```
hal config deploy ha rosco enable [parameters]
```
