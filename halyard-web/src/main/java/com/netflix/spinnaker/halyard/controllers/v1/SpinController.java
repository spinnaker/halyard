...
public class SpinController {
  ...
  DaemonTask<Halconfig, String> install(@PathVariable String version) {
    StaticRequestBuilder<String> builder = new StaticRequestBuilder<>(() -> spinService.install(version));
