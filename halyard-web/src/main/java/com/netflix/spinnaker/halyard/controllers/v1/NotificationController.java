...
public class NotificationController {
    ...
    DaemonTask<Halconfig, Notification> get(
        ...
        builder.setBuildResponse(() -> notificationService.getNotification(deploymentName, notificationName));
        ...
        return DaemonTaskHandler.submitTask(builder::build, "Get the " + notificationName + " notification");
    }
