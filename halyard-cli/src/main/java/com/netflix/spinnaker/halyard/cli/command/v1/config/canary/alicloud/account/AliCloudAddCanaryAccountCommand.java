...
public class AliCloudAddCanaryAccountCommand extends AbstractAddCanaryAccountCommand {
  ...
  protected AbstractCanaryAccount buildAccount(Canary canary, String accountName) {
    AliCloudCanaryAccount account =
        (AliCloudCanaryAccount) new AliCloudCanaryAccount().setName(accountName);
  ...
  protected AbstractCanaryAccount emptyAccount() {
    return new AliCloudCanaryAccount();
  }
}
