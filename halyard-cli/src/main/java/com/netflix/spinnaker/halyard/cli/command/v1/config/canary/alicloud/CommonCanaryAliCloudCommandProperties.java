...
public class CommonCanaryAliCloudCommandProperties {
  public static final String REGION_DESCRIPTION = "The region to use.";

  public static final String ENDPOINT_DESCRIPTION =
      "The endpoint used to reach the service implementing the alicloud api. Typical use is with Minio.";

  public static final String ACCESS_KEY_ID_DESCRIPTION =
      "The default access key used to communicate with alicloud.";

  public static final String SECRET_KEY_DESCRIPTION =
      "The secret key used to communicate with alicloud.";
}
