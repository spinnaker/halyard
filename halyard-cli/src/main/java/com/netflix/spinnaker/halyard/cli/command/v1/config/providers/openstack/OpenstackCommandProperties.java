...
public class OpenstackCommandProperties {
    ...
    static final String INSECURE_DESCRIPTION = "Disable certificate validation on SSL connections. Default false.";

    static final String USER_DATA_FILE_DESCRIPTION = "User data passed to Heat Orchestration Template.";
