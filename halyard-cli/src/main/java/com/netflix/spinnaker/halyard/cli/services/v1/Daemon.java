...
public class Daemon {
  ...
  public static Supplier<Void> setCurrentDeployment(String name) {
    return () -> ResponseUnwrapper
        .get(getService().setCurrentDeployment(new StringBodyRequest(name)));
  }

  public static Supplier<DeploymentConfiguration> getDeploymentConfiguration(String deploymentName,
      boolean validate) {
    return () -> {
      Object rawDeploymentConfiguration = ResponseUnwrapper
          .get(getService().getDeployment(deploymentName, validate));
      return getObjectMapper()
          .convertValue(rawDeploymentConfiguration, DeploymentConfiguration.class);
    };
  }

  public static Supplier<Void> setDeploymentConfiguration(String deploymentName, boolean validate,
      DeploymentConfiguration deploymentConfiguration) {
    return () -> ResponseUnwrapper
        .get(getService().setDeployment(deploymentName, validate, deploymentConfiguration));
  }

  public static Supplier<DeploymentEnvironment> getDeploymentEnvironment(String deploymentName,
      boolean validate) {
    return () -> {
      Object rawDeploymentEnvironment = ResponseUnwrapper
          .get(getService().getDeploymentEnvironment(deploymentName, validate));
      return getObjectMapper().convertValue(rawDeploymentEnvironment, DeploymentEnvironment.class);
    };
  }

  public static Supplier<Void> setDeploymentEnvironment(String deploymentName, boolean validate,
  ...
  public static Supplier<BakeryDefaults> getBakeryDefaults(String deploymentName,
      String providerName, boolean validate) {
    return () -> {
      Object rawBakeryDefaults = ResponseUnwrapper
          .get(getService().getBakeryDefaults(deploymentName, providerName, validate));
      return getObjectMapper()
          .convertValue(rawBakeryDefaults, Providers.translateBakeryDefaultsType(providerName));
    };
  }

  public static Supplier<Void> setBakeryDefaults(String deploymentName, String providerName,
      boolean validate, BakeryDefaults bakeryDefaults) {
    return () -> {
      ResponseUnwrapper.get(
  ...
  public static Supplier<Features> getFeatures(String deploymentName, boolean validate) {
    return () -> {
      Object rawFeatures = ResponseUnwrapper
          .get(getService().getFeatures(deploymentName, validate));
      return getObjectMapper().convertValue(rawFeatures, Features.class);
    };
  }

  public static Supplier<Void> setFeatures(String deploymentName, boolean validate,
      Features features) {
    return () -> {
  ...
  public static Supplier<PersistentStorage> getPersistentStorage(String deploymentName,
      boolean validate) {
    return () -> {
      Object rawPersistentStorage = ResponseUnwrapper
          .get(getService().getPersistentStorage(deploymentName, validate));
  ...
  public static Supplier<PersistentStore> getPersistentStore(String deploymentName,
      String persistentStoreType, boolean validate) {
    return () -> {
      Object rawPersistentStore = ResponseUnwrapper
          .get(getService().getPersistentStore(deploymentName, persistentStoreType, validate));
      return getObjectMapper().convertValue(rawPersistentStore,
          PersistentStorage.translatePersistentStoreType(persistentStoreType));
    };
  }

  public static Supplier<Void> setPersistentStorage(String deploymentName, boolean validate,
      PersistentStorage persistentStorage) {
    return () -> {
      ResponseUnwrapper
          .get(getService().setPersistentStorage(deploymentName, validate, persistentStorage));
      return null;
    };
  }

  public static Supplier<Void> setPersistentStore(String deploymentName, String persistentStoreType,
      boolean validate, PersistentStore persistentStore) {
    return () -> {
      ResponseUnwrapper.get(getService()
          .setPersistentStore(deploymentName, persistentStoreType, validate, persistentStore));
      return null;
    };
  }

  public static Supplier<BaseImage> getBaseImage(String deploymentName, String providerName,
      String baseImageId, boolean validate) {
    return () -> {
      Object rawBaseImage = ResponseUnwrapper
          .get(getService().getBaseImage(deploymentName, providerName, baseImageId, validate));
      return getObjectMapper()
          .convertValue(rawBaseImage, Providers.translateBaseImageType(providerName));
    };
  }

  public static Supplier<Void> addBaseImage(String deploymentName, String providerName,
      boolean validate, BaseImage baseImage) {
    return () -> {
      ResponseUnwrapper
          .get(getService().addBaseImage(deploymentName, providerName, validate, baseImage));
      return null;
    };
  }

  public static Supplier<Void> setBaseImage(String deploymentName, String providerName,
      String baseImageId, boolean validate, BaseImage baseImage) {
    return () -> {
      ResponseUnwrapper.get(getService()
  ...
  public static Supplier<Void> deleteBaseImage(String deploymentName, String providerName,
      String baseImageId, boolean validate) {
    return () -> {
      ResponseUnwrapper
          .get(getService().deleteBaseImage(deploymentName, providerName, baseImageId, validate));
      return null;
    };
  }

  public static Supplier<Subscription> getSubscription(String deploymentName, String pubsubName,
      String subscriptionName, boolean validate) {
    return () -> {
      Object rawSubscription = ResponseUnwrapper.get(
  ...
  public static Supplier<Void> addSubscription(String deploymentName, String pubsubName,
      boolean validate, Subscription subscription) {
    return () -> {
      ResponseUnwrapper
          .get(getService().addSubscription(deploymentName, pubsubName, validate, subscription));
      return null;
    };
  }

  public static Supplier<Void> setSubscription(String deploymentName, String pubsubName,
      String subscriptionName, boolean validate, Subscription subscription) {
    return () -> {
      ResponseUnwrapper.get(getService()
          .setSubscription(deploymentName, pubsubName, subscriptionName, validate, subscription));
      return null;
    };
  }

  public static Supplier<Void> deleteSubscription(String deploymentName, String pubsubName,
      String subscriptionName, boolean validate) {
    return () -> {
      ResponseUnwrapper.get(
  ...
  public static Supplier<Account> getAccount(String deploymentName, String providerName,
      String accountName, boolean validate) {
    return () -> {
      Object rawAccount = ResponseUnwrapper
          .get(getService().getAccount(deploymentName, providerName, accountName, validate));
      return getObjectMapper()
          .convertValue(rawAccount, Providers.translateAccountType(providerName));
    };
  }

  public static Supplier<Void> addAccount(String deploymentName, String providerName,
      boolean validate, Account account) {
    return () -> {
      ResponseUnwrapper
          .get(getService().addAccount(deploymentName, providerName, validate, account));
      return null;
    };
  }

  public static Supplier<Void> setAccount(String deploymentName, String providerName,
      String accountName, boolean validate, Account account) {
    return () -> {
      ResponseUnwrapper.get(
  ...
  public static Supplier<Void> deleteAccount(String deploymentName, String providerName,
      String accountName, boolean validate) {
    return () -> {
      ResponseUnwrapper
          .get(getService().deleteAccount(deploymentName, providerName, accountName, validate));
      return null;
    };
  }

  public static Supplier<AbstractCanaryAccount> getCanaryAccount(String deploymentName,
      String serviceIntegrationName, String accountName, boolean validate) {
    return () -> {
      Object rawAccount = ResponseUnwrapper.get(getService()
  ...
  public static Supplier<Void> addCanaryAccount(String deploymentName,
      String serviceIntegrationName, boolean validate, AbstractCanaryAccount account) {
    return () -> {
      ResponseUnwrapper.get(
  ...
  public static Supplier<Void> setCanaryAccount(String deploymentName,
      String serviceIntegrationName, String accountName, boolean validate,
      AbstractCanaryAccount account) {
    return () -> {
      ResponseUnwrapper.get(getService()
          .setCanaryAccount(deploymentName, serviceIntegrationName, accountName, validate,
              account));
      return null;
    };
  }

  public static Supplier<Void> deleteCanaryAccount(String deploymentName,
      String serviceIntegrationName, String accountName, boolean validate) {
    return () -> {
      ResponseUnwrapper.get(getService()
  ...
  public static Supplier<ArtifactAccount> getArtifactAccount(String deploymentName,
      String providerName, String accountName, boolean validate) {
    return () -> {
      Object rawArtifactAccount = ResponseUnwrapper.get(
  ...
  public static Supplier<Void> addArtifactAccount(String deploymentName, String providerName,
      boolean validate, ArtifactAccount account) {
    return () -> {
      ResponseUnwrapper
          .get(getService().addArtifactAccount(deploymentName, providerName, validate, account));
      return null;
    };
  }

  public static Supplier<Void> setArtifactAccount(String deploymentName, String providerName,
      String accountName, boolean validate, ArtifactAccount account) {
    return () -> {
      ResponseUnwrapper.get(getService()
  ...
  public static Supplier<Void> deleteArtifactAccount(String deploymentName, String providerName,
      String accountName, boolean validate) {
    return () -> {
      ResponseUnwrapper.get(
  ...
  public static Supplier<List<String>> getNewAccountOptions(String deploymentName,
      String providerName, String fieldName, Account account) {
    return () -> {
      DaemonOptions<Account> accountOptions = new DaemonOptions<Account>().setField(fieldName)
          .setResource(account);
      return ResponseUnwrapper
          .get(getService().getNewAccountOptions(deploymentName, providerName, accountOptions));
    };
  }

  public static Supplier<List<String>> getExistingAccountOptions(String deploymentName,
      String providerName, String accountName, String fieldName) {
    return () -> {
  ...
  public static Supplier<Cluster> getCluster(String deploymentName, String providerName,
      String clusterName, boolean validate) {
    return () -> {
      Object rawCluster = ResponseUnwrapper
          .get(getService().getCluster(deploymentName, providerName, clusterName, validate));
      return getObjectMapper()
          .convertValue(rawCluster, Providers.translateClusterType(providerName));
    };
  }

  public static Supplier<Void> addCluster(String deploymentName, String providerName,
      boolean validate, Cluster cluster) {
    return () -> {
      ResponseUnwrapper
          .get(getService().addCluster(deploymentName, providerName, validate, cluster));
      return null;
    };
  }

  public static Supplier<Void> setCluster(String deploymentName, String providerName,
      String clusterName, boolean validate, Cluster cluster) {
    return () -> {
      ResponseUnwrapper.get(
  ...
  public static Supplier<Void> deleteCluster(String deploymentName, String providerName,
      String clusterName, boolean validate) {
    return () -> {
      ResponseUnwrapper
          .get(getService().deleteCluster(deploymentName, providerName, clusterName, validate));
      return null;
    };
  }

  public static Supplier<Void> setPubsub(String deploymentName, String pubsubName, boolean validate,
      Pubsub pubsub) {
    return () -> {
  ...
  public static Supplier<Pubsub> getPubsub(String deploymentName, String pubsubName,
      boolean validate) {
    return () -> {
      Object pubsub = ResponseUnwrapper
          .get(getService().getPubsub(deploymentName, pubsubName, validate));
      return getObjectMapper().convertValue(pubsub, Pubsubs.translatePubsubType(pubsubName));
    };
  }

  public static Supplier<Void> setPubsubEnableDisable(String deploymentName, String pubsubName,
      boolean validate, boolean enable) {
    return () -> {
      ResponseUnwrapper
          .get(getService().setPubsubEnabled(deploymentName, pubsubName, validate, enable));
      return null;
    };
  }

  public static Supplier<Void> setProvider(String deploymentName, String providerName,
      boolean validate, Provider provider) {
    return () -> {
      ResponseUnwrapper
          .get(getService().setProvider(deploymentName, providerName, validate, provider));
      return null;
    };
  }

  public static Supplier<Provider> getProvider(String deploymentName, String providerName,
      boolean validate) {
    return () -> {
      Object provider = ResponseUnwrapper
          .get(getService().getProvider(deploymentName, providerName, validate));
      return getObjectMapper()
          .convertValue(provider, Providers.translateProviderType(providerName));
    };
  }

  public static Supplier<Void> setProviderEnableDisable(String deploymentName, String providerName,
      boolean validate, boolean enable) {
    return () -> {
      ResponseUnwrapper
          .get(getService().setProviderEnabled(deploymentName, providerName, validate, enable));
      return null;
    };
  }

  public static Supplier<Void> setArtifactProvider(String deploymentName, String providerName,
      boolean validate, ArtifactProvider provider) {
    return () -> {
      ResponseUnwrapper
          .get(getService().setArtifactProvider(deploymentName, providerName, validate, provider));
      return null;
    };
  }
  ...
  public static Supplier<ArtifactProvider> getArtifactProvider(String deploymentName,
    ...
    return () -> {
      Object provider = ResponseUnwrapper
          .get(getService().getArtifactProvider(deploymentName, providerName, validate));
      return getObjectMapper()
          .convertValue(provider, Artifacts.translateArtifactProviderType(providerName));
    };
  }

  public static Supplier<Void> setArtifactProviderEnableDisable(String deploymentName,
      String providerName, boolean validate, boolean enable) {
    return () -> {
      ResponseUnwrapper.get(
  ...
  public static Supplier<Notifications> getNotifications(String deploymentName, boolean validate) {
    return () -> {
      Object notification = ResponseUnwrapper
          .get(getService().getNotifications(deploymentName, validate));
      return getObjectMapper().convertValue(notification, Notifications.class);
    };
  }

  public static Supplier<Void> setNotification(String deploymentName, String notificationName,
  ...
  public static Supplier<Notification> getNotification(String deploymentName,
      String notificationName, boolean validate) {
    return () -> {
      Object notification = ResponseUnwrapper
          .get(getService().getNotification(deploymentName, notificationName, validate));
      return getObjectMapper()
          .convertValue(notification, Notifications.translateNotificationType(notificationName));
    };
  }

  public static Supplier<Void> setNotificationEnabled(String deploymentName,
      String notificationName, boolean validate, boolean enable) {
    return () -> {
      ResponseUnwrapper.get(
  ...
  public static Supplier<Master> getMaster(String deploymentName, String ciName, String masterName,
      boolean validate) {
    return () -> {
      Object rawMaster = ResponseUnwrapper
          .get(getService().getMaster(deploymentName, ciName, masterName, validate));
      return getObjectMapper().convertValue(rawMaster, Cis.translateMasterType(ciName));
    };
  }

  public static Supplier<Void> addMaster(String deploymentName, String ciName, boolean validate,
      Master master) {
    return () -> {
  ...
  public static Supplier<Void> setMaster(String deploymentName, String ciName, String masterName,
      boolean validate, Master master) {
    return () -> {
      ResponseUnwrapper
          .get(getService().setMaster(deploymentName, ciName, masterName, validate, master));
      return null;
    };
  }

  public static Supplier<Void> deleteMaster(String deploymentName, String ciName, String masterName,
      boolean validate) {
    return () -> {
      ResponseUnwrapper
          .get(getService().deleteMaster(deploymentName, ciName, masterName, validate));
      return null;
    };
  }
  ...
  public static Supplier<Void> setCiEnableDisable(String deploymentName, String ciName,
      boolean validate, boolean enable) {
    return () -> {
  ...
  public static Supplier<RemoteAction> connectToDeployment(String deploymentName, boolean validate,
      List<String> serviceNames) {
    return () -> {
      Object rawDeployResult = ResponseUnwrapper
          .get(getService().connectToDeployment(deploymentName, validate, serviceNames, ""));
      return getObjectMapper().convertValue(rawDeployResult, RemoteAction.class);
    };
  }

  public static Supplier<RemoteAction> prepDeployment(String deploymentName, boolean validate,
      List<String> serviceNames, List<String> excludeServiceNames) {
    return () -> {
      Object rawDeployResult = ResponseUnwrapper.get(getService()
          .prepDeployment(deploymentName, validate, serviceNames, excludeServiceNames, ""));
      return getObjectMapper().convertValue(rawDeployResult, RemoteAction.class);
    };
  }

  public static Supplier<RemoteAction> deployDeployment(String deploymentName, boolean validate,
      List<DeployOption> deployOptions, List<String> serviceNames,
      List<String> excludeServiceNames) {
    return () -> {
      Object rawDeployResult = ResponseUnwrapper.get(getService()
          .deployDeployment(deploymentName, validate, deployOptions, serviceNames,
              excludeServiceNames, ""));
      return getObjectMapper().convertValue(rawDeployResult, RemoteAction.class);
    };
  }

  public static Supplier<Void> collectLogs(String deploymentName, boolean validate,
      List<String> serviceNames, List<String> excludeServiceNames) {
    return () -> {
      ResponseUnwrapper.get(getService()
  ...
  public static Supplier<MetricStores> getMetricStores(String deploymentName, boolean validate) {
    return () -> {
      Object rawMetricStores = ResponseUnwrapper
          .get(getService().getMetricStores(deploymentName, validate));
      return getObjectMapper().convertValue(rawMetricStores, MetricStores.class);
    };
  }

  public static Supplier<Void> setMetricStores(String deploymentName, boolean validate,
  ...
  public static Supplier<MetricStore> getMetricStore(String deploymentName, String metricStoreType,
      boolean validate) {
    return () -> {
      Object rawMetricStore = ResponseUnwrapper
          .get(getService().getMetricStore(deploymentName, metricStoreType, validate));
      return getObjectMapper()
          .convertValue(rawMetricStore, MetricStores.translateMetricStoreType(metricStoreType));
    };
  }

  public static Supplier<Void> setMetricStore(String deploymentName, String metricStoreType,
      boolean validate, MetricStore metricStore) {
    return () -> {
  ...
  public static Supplier<Void> setMetricStoreEnabled(String deploymentName, String metricStoreType,
      boolean validate, boolean enabled) {
    return () -> {
      ResponseUnwrapper.get(
  ...
  public static Supplier<Security> getSecurity(String deploymentName, boolean validate) {
    return () -> {
      Object rawSecurity = ResponseUnwrapper
          .get(getService().getSecurity(deploymentName, validate));
      return getObjectMapper().convertValue(rawSecurity, Security.class);
    };
  }

  public static Supplier<Void> setSecurity(String deploymentName, boolean validate,
      Security security) {
    return () -> {
  ...
  public static Supplier<ApiSecurity> getApiSecurity(String deploymentName, boolean validate) {
    return () -> {
      Object rawApiSecurity = ResponseUnwrapper
          .get(getService().getApiSecurity(deploymentName, validate));
      return getObjectMapper().convertValue(rawApiSecurity, ApiSecurity.class);
    };
  }

  public static Supplier<Void> setApiSecurity(String deploymentName, boolean validate,
  ...
  public static Supplier<SpringSsl> getSpringSsl(String deploymentName, boolean validate) {
    return () -> {
      Object rawSpringSsl = ResponseUnwrapper
          .get(getService().getSpringSsl(deploymentName, validate));
      return getObjectMapper().convertValue(rawSpringSsl, SpringSsl.class);
    };
  }

  public static Supplier<Void> setSpringSsl(String deploymentName, boolean validate,
      SpringSsl apacheSsl) {
    return () -> {
  ...
  public static Supplier<Void> setSpringSslEnabled(String deploymentName, boolean validate,
      boolean enabled) {
    return () -> {
  ...
  public static Supplier<UiSecurity> getUiSecurity(String deploymentName, boolean validate) {
    return () -> {
      Object rawUiSecurity = ResponseUnwrapper
          .get(getService().getUiSecurity(deploymentName, validate));
      return getObjectMapper().convertValue(rawUiSecurity, UiSecurity.class);
    };
  }

  public static Supplier<Void> setUiSecurity(String deploymentName, boolean validate,
  ...
  public static Supplier<ApacheSsl> getApacheSsl(String deploymentName, boolean validate) {
    return () -> {
      Object rawApacheSsl = ResponseUnwrapper
          .get(getService().getApacheSsl(deploymentName, validate));
      return getObjectMapper().convertValue(rawApacheSsl, ApacheSsl.class);
    };
  }

  public static Supplier<Void> setApacheSsl(String deploymentName, boolean validate,
      ApacheSsl apacheSsl) {
    return () -> {
  ...
  public static Supplier<Void> setApacheSslEnabled(String deploymentName, boolean validate,
      boolean enabled) {
    return () -> {
  ...
  public static Supplier<AuthnMethod> getAuthnMethod(String deploymentName, String methodName,
      boolean validate) {
    return () -> {
      Object rawOAuth2 = ResponseUnwrapper
          .get(getService().getAuthnMethod(deploymentName, methodName, validate));
      return getObjectMapper()
          .convertValue(rawOAuth2, AuthnMethod.translateAuthnMethodName(methodName));
    };
  }

  public static Supplier<Void> setAuthnMethod(String deploymentName, String methodName,
      boolean validate, AuthnMethod authnMethod) {
    return () -> {
      ResponseUnwrapper
          .get(getService().setAuthnMethod(deploymentName, methodName, validate, authnMethod));
      return null;
    };
  }

  public static Supplier<Void> setGroupMembership(String deploymentName, boolean validate,
  ...
  public static Supplier<GroupMembership> getGroupMembership(String deploymentName,
      boolean validate) {
    return () -> {
      Object rawGroupMembership = ResponseUnwrapper
          .get(getService().getGroupMembership(deploymentName, validate));
      return getObjectMapper().convertValue(rawGroupMembership, GroupMembership.class);
    };
  }

  public static Supplier<RoleProvider> getRoleProvider(String deploymentName,
      String roleProviderName, boolean validate) {
    return () -> {
      Object rawRoleProvider = ResponseUnwrapper
          .get(getService().getRoleProvider(deploymentName, roleProviderName, validate));
      return getObjectMapper().convertValue(rawRoleProvider,
          GroupMembership.translateRoleProviderType(roleProviderName));
    };
  }

  public static Supplier<Void> setRoleProvider(String deploymentName, String roleProviderName,
      boolean validate, RoleProvider authnMethod) {
    return () -> {
      ResponseUnwrapper.get(
  ...
  public static Supplier<Void> setAuthzEnabled(String deploymentName, boolean validate,
      boolean enabled) {
    return () -> {
  ...
  public static Supplier<Void> setAuthnMethodEnabled(String deploymentName, String methodName,
      boolean validate, boolean enabled) {
    return () -> {
      ResponseUnwrapper
          .get(getService().setAuthnMethodEnabled(deploymentName, methodName, validate, enabled));
      return null;
    };
  }
  ...
  public static Supplier<Void> setCanaryEnabled(String deploymentName, boolean validate,
      boolean enabled) {
    return () -> {
  ...
  public static Supplier<RunningServiceDetails> getServiceDetails(String deploymentName,
      String serviceName, boolean validate) {
    return () -> {
      Object rawDetails = ResponseUnwrapper
          .get(getService().getServiceDetails(deploymentName, serviceName, validate));
  ...
  public static Supplier<Void> publishProfile(String bomPath, String artifactName,
      String profilePath) {
    return () -> {
  ...
  public static Supplier<Void> setVersion(String deploymentName, boolean validate,
      String versionName) {
    return () -> {
