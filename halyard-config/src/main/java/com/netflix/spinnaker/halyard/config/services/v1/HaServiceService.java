...
import com.netflix.spinnaker.halyard.config.model.v1.ha.FiatHaService;
import com.netflix.spinnaker.halyard.config.model.v1.ha.Front50HaService;
import com.netflix.spinnaker.halyard.config.model.v1.ha.GateHaService;
import com.netflix.spinnaker.halyard.config.model.v1.ha.HaService;
import com.netflix.spinnaker.halyard.config.model.v1.ha.HaServices;
import com.netflix.spinnaker.halyard.config.model.v1.ha.IgorHaService;
import com.netflix.spinnaker.halyard.config.model.v1.ha.KayentaHaService;
import com.netflix.spinnaker.halyard.config.model.v1.ha.OrcaHaService;
import com.netflix.spinnaker.halyard.config.model.v1.ha.RoscoHaService;
  ...
  public void setHaService(String deploymentName, HaService haService) {
    ...
    switch (haService.haServiceType()) {
      ...
      case ECHO:
        ...
        break;
      case FIAT:
        haServices.setFiat((FiatHaService) haService);
        break;
      case FRONT50:
        haServices.setFront50((Front50HaService) haService);
        break;
      case GATE:
        haServices.setGate((GateHaService) haService);
        break;
      case IGOR:
        haServices.setIgor((IgorHaService) haService);
        break;
      case KAYENTA:
        haServices.setKayenta((KayentaHaService) haService);
        break;
      case ORCA:
        haServices.setOrca((OrcaHaService) haService);
        break;
      case ROSCO:
        haServices.setRosco((RoscoHaService) haService);
        break;
      default:
